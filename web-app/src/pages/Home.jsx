  ...
  const solutionSteps = [
    {
      ...
      icon: (
        <path
          d="M3 21h18 M5 21V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16 M9 21v-4a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v4 M10 9h4 M12 7v4"
          strokeLinecap="round"
    ...
    },
    {
      ...
      icon: (
        <>
          <path d="m18 2 4 4" strokeLinecap="round" strokeLinejoin="round" />
          <path d="m17 7 3-3" strokeLinecap="round" strokeLinejoin="round" />
          <path
            d="M19 9 8.7 19.3c-1 1-2.5 1-3.4 0l-.6-.6c-1-1-1-2.5 0-3.4L15 5"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
          <path d="m9 11 4 4" strokeLinecap="round" strokeLinejoin="round" />
          <path d="m5 19-3 3" strokeLinecap="round" strokeLinejoin="round" />
          <path d="m14 4 6 6" strokeLinecap="round" strokeLinejoin="round" />
        </>
      ),
    },
    {
      ...
      icon: (
        <>
          <path
            d="M9 2v17.5A2.5 2.5 0 0 0 11.5 22A2.5 2.5 0 0 0 14 19.5V2"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
          <path d="M8.5 2h7" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M14 9H9" strokeLinecap="round" strokeLinejoin="round" />
        </>
      ),
    },
    {
      ...
      <section className="flex items-center min-h-[calc(100vh-80px)] relative w-full m-0 py-16 flex-col lg:flex-row lg:px-0 bg-gradient-to-b from-sky-50/60 via-white to-white overflow-hidden">
        ...
        >
          <motion.h1
            ...
            style={{
              fontSize: "clamp(2.25rem, 3vw, 52px)",
          ...
          >
            <Link
              to="/products"
              className="bg-accent text-white px-8 py-4 rounded-full font-semibold text-[15px] transition-all hover:bg-accent-hover hover:-translate-y-1 hover:shadow-[0_8px_25px_rgba(2,132,199,0.35)] min-w-[200px] flex justify-center items-center"
            >
              {t("home.exploreTech")}
            </Link>
            <Link
              to="/about"
              className="bg-white text-slate-700 border-2 border-slate-200 px-8 py-4 rounded-full font-semibold text-[15px] transition-all hover:border-slate-300 hover:bg-slate-50 hover:-translate-y-1 hover:shadow-sm min-w-[160px] flex justify-center items-center"
            >
              {t("home.learnMore")}
            </Link>
          </motion.div>
            ...
            <div className="w-full lg:w-1/2 rounded-[28px] overflow-hidden bg-white flex flex-col items-center justify-center p-8 lg:p-12 shadow-sm border border-slate-100 relative min-h-[450px]">
              ...
              <div className="relative z-10 w-full flex-1 flex items-center justify-center mb-8">
                <img
                  key={
                    currentIdx
                  } /* Key ensures re-render animation if needed */
              ...
              <div className="relative z-10 flex items-center gap-6 mt-auto">
                <button
                  onClick={prevSlide}
                  className="w-10 h-10 rounded-full border border-slate-200 bg-white shadow-sm flex items-center justify-center text-slate-500 hover:text-accent hover:border-accent hover:shadow transition-all group/btn cursor-pointer"
                >
                  <svg
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center text-center lg:text-left">
              ...
              <ul className="space-y-4 mb-10 text-left">
                <li className="flex items-center gap-4 text-slate-700 font-medium text-lg">
                  <div className="w-8 h-8 rounded-full bg-accent text-white flex items-center justify-center shadow-md flex-shrink-0">
                    ✓
                  </div>
                  {t("home.xzensePoint1")}
                </li>
              ...
              <div className="self-center lg:self-start mt-2">
                <Link
                  to="/technology"
                  className="bg-slate-900 text-white px-8 py-4 rounded-full font-semibold text-[15px] transition-all hover:bg-accent hover:-translate-y-1 hover:shadow-[0_10px_20px_rgba(2,132,199,0.3)] inline-flex items-center gap-3"
                >
            ...
            <AppCard
              ...
              icon={
                ...
                >
                  ...
                  <path d="M19.3 14.8a10 10 0 0 0-14.6-5.6"></path>
                  <path d="M4.7 14.8a10 10 0 0 0 14.6-5.6"></path>
                  <path d="M9.2 4.7a10 10 0 0 0-5.6 14.6"></path>
                  <path d="M14.8 19.3a10 10 0 0 0 5.6-14.6"></path>
                </svg>
              }
            />
            <AppCard
            ...
            <AppCard
              ...
              icon={
                <svg
                  ...
                  strokeLinejoin="round"
                >
                  <path d="M10.5 4.5a3.53 3.53 0 0 0-5 0v0a3.53 3.53 0 0 0 0 5l8 8a3.53 3.53 0 0 0 5 0v0a3.53 3.53 0 0 0 0-5l-8-8z" />
                  <path d="M12 18l3-3" />
                  <path d="M15 21l3-3" />
                  <line x1="16.5" x2="7.5" y1="7.5" y2="16.5" />
                </svg>
              }
            />
            <AppCard
            ...
            <AppCard
              ...
              icon={
                ...
                >
                  ...
                  <polyline points="5 10 9 10 12 5 15 14 18 10 21 10"></polyline>
                </svg>
              }
            />
          </motion.div>
        ...
        <div className="max-w-[1200px] mx-auto space-y-20">
          ...
          <div>
            ...
            >
              {[
                {
                  title: t("home.nationalInnovationAward"),
                  src: "/award-1.jpg",
                },
  ...
  >
    <motion.div
      whileHover={{
        y: -8,
        boxShadow:
          "0 20px 40px -10px rgba(14,165,233,0.2), 0 10px 20px -5px rgba(14,165,233,0.1)",
      }}
