...
export default function Contacts() {
  ...
  const getInputClass = (fieldName) => {
    const base = "w-full px-4 py-3 rounded-xl border bg-slate-50 focus:bg-white focus:outline-none focus:ring-2 transition-all text-slate-900";
    if (errors[fieldName]) {
        ...
        <div className="grid lg:grid-cols-[1fr_1.3fr] gap-12 lg:gap-16">
          ...
          >
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
              ...
              <p className="text-slate-500 font-mono mt-1 text-sm bg-slate-100 inline-block px-3 py-1 rounded-md">Tax ID no: 0305565004265</p>
            </div>
