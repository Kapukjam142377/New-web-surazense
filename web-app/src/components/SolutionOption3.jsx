...
const SolutionOption3 = ({ steps }) => {
   return (
      <div className="w-full relative py-12 md:py-24 mb-12 flex flex-col items-center overflow-hidden">
         {/* Background Decor */}
         <div className="absolute inset-0 bg-transparent opacity-[0.03] z-0" style={{ backgroundImage: 'radial-gradient(#185FA5 2px, transparent 2px)', backgroundSize: '40px 40px' }}></div>
         ...
         >
            ...
            <div className="flex items-center gap-1.5 mb-2 bg-white/20 px-2.5 py-1 rounded-full border border-white/10 backdrop-blur-md">
               ...
               <span className="text-[10px] uppercase font-bold text-white tracking-wider">Live Result</span>
            </div>
            <h4 className="text-[18px] font-extrabold mb-1 relative z-10 leading-tight">Cancer Signal</h4>
            <h4 className="text-[18px] font-extrabold relative z-10 text-blue-200">Detection</h4>
         </motion.div>
         ...
         <div className="absolute inset-0 pointer-events-none z-10 hidden md:block">
            ...
            >
               <div className="flex items-center gap-4 mb-3 border-b border-slate-50 pb-3">
                  <div className="w-12 h-12 bg-blue-50 text-blue-600 rounded-xl flex items-center justify-center shrink-0">
                     <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">{steps[0].icon}</svg>
                  </div>
                  <div>
                     <div className="text-[10px] font-black uppercase text-slate-400">Step 1</div>
                     <div className="font-bold text-[#0C447C] leading-tight">{steps[0].title}</div>
                  </div>
               </div>
               <p className="text-[13px] text-slate-500 leading-relaxed">{steps[0].desc}</p>
            </motion.div>
            ...
            >
               <div className="flex items-center gap-4 mb-3 border-b border-slate-50 pb-3">
                  <div className="w-12 h-12 bg-blue-50 text-blue-600 rounded-xl flex items-center justify-center shrink-0">
                     <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">{steps[1].icon}</svg>
                  </div>
                  <div>
                     <div className="text-[10px] font-black uppercase text-slate-400">Step 2</div>
                     <div className="font-bold text-[#0C447C] leading-tight">{steps[1].title}</div>
                  </div>
               </div>
               <p className="text-[13px] text-slate-500 leading-relaxed">{steps[1].desc}</p>
            </motion.div>
            ...
            >
               <div className="flex items-center gap-4 mb-3 border-b border-slate-50 pb-3">
                  <div className="w-12 h-12 bg-blue-50 text-blue-600 rounded-xl flex items-center justify-center shrink-0">
                     <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">{steps[2].icon}</svg>
                  </div>
                  <div>
                     <div className="text-[10px] font-black uppercase text-slate-400">Step 3</div>
                     <div className="font-bold text-[#0C447C] leading-tight">{steps[2].title}</div>
                  </div>
               </div>
               <p className="text-[13px] text-slate-500 leading-relaxed">{steps[2].desc}</p>
            </motion.div>
            ...
            >
               <div className="flex items-center gap-4 mb-3 border-b border-slate-50 pb-3">
                  <div className="w-12 h-12 bg-blue-50 text-blue-600 rounded-xl flex items-center justify-center shrink-0">
                     <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">{steps[3].icon}</svg>
                  </div>
                  <div>
                     <div className="text-[10px] font-black uppercase text-slate-400">Step 4</div>
                     <div className="font-bold text-[#0C447C] leading-tight">{steps[3].title}</div>
                  </div>
               </div>
               <p className="text-[13px] text-slate-500 leading-relaxed">{steps[3].desc}</p>
            </motion.div>
         ...
         <div className="w-full flex flex-col md:hidden gap-4 px-6 mt-8 relative z-30">
            {steps.map((step, idx) => (
               <div key={idx} className="bg-white p-5 rounded-2xl shadow border border-slate-100 flex items-center gap-4">
                  <div className="w-12 h-12 bg-blue-50 text-blue-600 rounded-xl flex items-center justify-center shrink-0">
                     <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">{step.icon}</svg>
                  </div>
                  <div>
                     <div className="text-[10px] font-black uppercase text-blue-500">Step {step.num}</div>
                     <div className="font-bold text-[#0C447C]">{step.title}</div>
                     <div className="text-[12px] text-slate-500 mt-1 line-clamp-1">{step.desc}</div>
                  </div>
               </div>
            ))}
         </div>
